...
test("reasoning curation is off by default and bounds every host-runtime model call", () => {
  const value = normalizeConfig({ cognition: { reasoningCuration: { intake: { enabled: true, maxCandidatesPerTurn: 99, timeoutMs: 1, maxInputChars: 1, maxOutputChars: 999999 }, formation: { enabled: true, maxJobsPerTurn: 99, minOutcomeConfidence: -1, timeoutMs: 1, maxInputChars: 1, maxOutputChars: 999999 }, review: { enabled: true, intervalHours: 0, maxItems: 99, timeoutMs: 999999, maxInputChars: 999999, maxOutputChars: 1 } } } }).cognition.reasoningCuration;
  assert.deepEqual(value, { intake: { enabled: true, maxCandidatesPerTurn: 2, timeoutMs: 1000, maxInputChars: 1000, maxOutputChars: 16000 }, formation: { enabled: true, maxJobsPerTurn: 3, minOutcomeConfidence: 0, timeoutMs: 1000, maxInputChars: 1000, maxOutputChars: 16000 }, review: { enabled: true, intervalHours: 1, maxItems: 20, timeoutMs: 120000, maxInputChars: 32000, maxOutputChars: 512 } });
});
