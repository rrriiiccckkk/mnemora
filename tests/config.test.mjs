...
test("reasoning runtime shadow remains off and clamps scope, quality, retention, and readiness policy", () => {
  ...
  assert.deepEqual(value, { shadowMode: true, scopes: ["project:a"], tokenBudget: 64, maxItems: 12, minConfidence: 0, highRiskMinConfidence: 1, minEvidenceQuality: 0, highRiskMinEvidenceQuality: 1, maxStalenessDays: 1, excludeConflicted: true, retentionDays: 365, readiness: { minimumRuns: 1, maxErrorRate: 1, maxEmptyRate: 0, maxP95Ms: 1 }, delivery: { enabled: false, scopes: [], adapter: "openclaw", calibrationMaxAgeHours: 168, maxConsecutiveDeliveries: 2, itemRetentionDays: 30 } });
});
