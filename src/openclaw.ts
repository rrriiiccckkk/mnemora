...
const optionalReviewKind = (value: unknown): "duplicates" | "anomalies" | "identity" | "schema_drift" | "semantic_patterns" | "hygiene" => value === "anomalies" || value === "identity" || value === "schema_drift" || value === "semantic_patterns" || value === "hygiene" ? value : "duplicates";
