...
export interface GraphReviewWorklistItem {
  id: string;
  kind: GraphReviewCandidateKind | "suspicious_self_link";
...
export class GraphReviewWorklistService {
  constructor(private readonly db: DatabaseSyncInstance, private readonly lifecycle: GraphReviewLifecycleRepository) {}
