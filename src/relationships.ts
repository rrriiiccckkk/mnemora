...
export const semanticVocabularies: readonly SemanticVocabularyEntry[] = [
  ...
  { domain: "investment", type: "develops", source: "company", target: "product|concept", directed: true },
...
export const relationshipDefinitions: Record<RelationshipType, RelationshipDefinition> = {
  ...
  develops: { type: "develops", source: "company", target: "product|concept", directed: true },
