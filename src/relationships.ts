...
export const semanticVocabularies: readonly SemanticVocabularyEntry[] = [
  ...
  { domain: "investment", type: "uses", source: "company", target: "technology|product", directed: true },
...
export const relationshipDefinitions: Record<RelationshipType, RelationshipDefinition> = {
  ...
  uses: { type: "uses", source: "company", target: "technology|product", directed: true },
